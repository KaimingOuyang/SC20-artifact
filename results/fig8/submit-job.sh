...
# original
export PATH=${ROOT_DIR}/installed/mpich-throughput-non-rev-bdw/bin:$PATH
mpicc ${C_INCLUDE} -o pingpong-original-cm-bdw ${ROOT_DIR}/app/cab-benchmark/pingpong/pingpong-reverse-papi.c ${LDFLAGS}
sbatch ${BDW_SLURM_PARAM} bdw-msg.job pingpong-original-cm-bdw pingpong-original-cm-bdw.out

# throughput
export PATH=${ROOT_DIR}/installed/mpich-throughput-rev-bdw/bin:$PATH
mpicc ${C_INCLUDE} -o pingpong-throughput-cm-bdw ${ROOT_DIR}/app/cab-benchmark/pingpong/pingpong-reverse-papi.c ${LDFLAGS}
