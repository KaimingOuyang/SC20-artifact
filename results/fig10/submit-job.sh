...
mpicc -o pingpong-fix-chunk-bdw ${ROOT_DIR}/app/cab-benchmark/pingpong/pingpong-algo.c
...
mpicc -o pingpong-dynamic-chunk-bdw ${ROOT_DIR}/app/cab-benchmark/pingpong/pingpong-algo.c
